...
public class SOAPServiceServiceLocator extends org.apache.axis.client.Service implements sample.service.SOAPServiceService {
    ...
    private java.lang.String SOAPService_address = "http://localhost:7001/SOAPServer/services/SOAPService";
    ...
    public sample.service.SOAPService getSOAPService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            sample.service.SOAPServiceSoapBindingStub _stub = new sample.service.SOAPServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (sample.service.SOAPService.class.isAssignableFrom(serviceEndpointInterface)) {
                sample.service.SOAPServiceSoapBindingStub _stub = new sample.service.SOAPServiceSoapBindingStub(new java.net.URL(SOAPService_address), this);
                _stub.setPortName(getSOAPServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.sample", "SOAPServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.sample", "SOAPService"));
        }
